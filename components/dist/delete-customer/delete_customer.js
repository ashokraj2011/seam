"use components";
import { delete as _delete } from '../../../src/runtime/caps/kv-store.js';
import { show } from '../../../src/runtime/caps/toast.js';
import { set } from '../../../src/runtime/caps/ui-state.js';
...
const _trampoline8 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
  var ptr0 = arg0;
  var len0 = arg1;
  ...
  _debugLog('[iface="app:caps/kv-store@0.1.0", function="delete"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => _delete(result0, result1, result2, result3),
    })
  };
} catch (e) {
...
switch (variant5.tag) {
  ...
  case 'err': {
    ...
    dataView(memory0).setUint32(arg8 + 8, len4, true);
    dataView(memory0).setUint32(arg8 + 4, ptr4, true);
...
_debugLog('[iface="app:caps/kv-store@0.1.0", function="delete"][Instruction::Return]', {
  funcName: 'delete',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline8.fnName = 'app:caps/kv-store@0.1.0#_delete';
...
const _trampoline9 = function(arg0, arg1, arg2, arg3) {
  ...
  var len1 = arg3;
  var result1 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr1, len1));
  _debugLog('[iface="app:caps/ui-state@0.1.0", function="set"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  _debugLog('[iface="app:caps/ui-state@0.1.0", function="set"][Instruction::Return]', {
    funcName: 'set',
    paramCount: 0,
    async: false,
    postReturn: false
...
_trampoline9.fnName = 'app:caps/ui-state@0.1.0#set';

const _trampoline10 = function(arg0, arg1) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="app:caps/toast@0.1.0", function="show"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  _debugLog('[iface="app:caps/toast@0.1.0", function="show"][Instruction::Return]', {
    funcName: 'show',
    paramCount: 0,
    async: false,
    postReturn: false
...
_trampoline10.fnName = 'app:caps/toast@0.1.0#show';
...
_trampoline12.fnName = 'wasi:filesystem/types@0.2.3#filesystemErrorCode';
...
_trampoline13.fnName = 'wasi:filesystem/types@0.2.3#writeViaStream';
...
_trampoline14.fnName = 'wasi:filesystem/types@0.2.3#appendViaStream';
...
_trampoline15.fnName = 'wasi:filesystem/types@0.2.3#getType';
...
_trampoline16.fnName = 'wasi:filesystem/types@0.2.3#stat';
...
_trampoline17.fnName = 'wasi:io/streams@0.2.3#checkWrite';
...
_trampoline18.fnName = 'wasi:io/streams@0.2.3#write';
...
_trampoline19.fnName = 'wasi:io/streams@0.2.3#blockingFlush';
...
_trampoline20.fnName = 'wasi:io/streams@0.2.3#blockingWriteAndFlush';
...
function invoke(arg0) {
  ...
  _debugLog('[iface="app:customer/delete-customer@0.1.0", function="invoke"][Instruction::CallWasm] enter', {
    funcName: 'invoke',
    paramCount: 2,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'deleteCustomer010Invoke',
    getCallbackFn: () => null,
    callbackFnName: null,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => deleteCustomer010Invoke(ptr1, len1),
    });
  } catch (err) {
  ...
  _debugLog('[iface="app:customer/delete-customer@0.1.0", function="invoke"][Instruction::Return]', {
    funcName: 'invoke',
    paramCount: 1,
    async: false,
    postReturn: true
...
null,
{
  ...
  paramLiftFns: [_liftFlatStringAny,_liftFlatStringAny,_liftFlatStringAny,_liftFlatStringAny],
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./delete_customer.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./delete_customer.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'app:caps/kv-store@0.1.0': {
        'delete': exports0['0'],
      },
      'app:caps/toast@0.1.0': {
        show: exports0['2'],
      },
      'app:caps/ui-state@0.1.0': {
        set: exports0['1'],
      },
    ...
    postReturn0 = exports1['cabi_post_app:customer/delete-customer@0.1.0#invoke'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_app:customer/delete-customer@0.1.0#invoke']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_app:customer/delete-customer@0.1.0#invoke'];
    }
    
    deleteCustomer010Invoke = exports1['app:customer/delete-customer@0.1.0#invoke'];
  })();
...
await $init;
const deleteCustomer010 = {
  invoke: invoke,
  
};

export { deleteCustomer010 as deleteCustomer, deleteCustomer010 as 'app:customer/delete-customer@0.1.0',  }