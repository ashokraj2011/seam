"use components";
import { insert } from '../../../src/runtime/caps/kv-store.js';
...
const _trampoline8 = function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
  ...
  _debugLog('[iface="app:caps/kv-store@0.1.0", function="insert"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="app:caps/kv-store@0.1.0", function="insert"][Instruction::Return]', {
  funcName: 'insert',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline8.fnName = 'app:caps/kv-store@0.1.0#insert';
...
_trampoline9.fnName = 'app:caps/toast@0.1.0#show';
...
_trampoline10.fnName = 'app:caps/ui-state@0.1.0#set';
...
let saveCustomer010Invoke;

function invoke(arg0) {
  var {name: v0_0, email: v0_1 } = arg0;
  ...
  _debugLog('[iface="app:customer/save-customer@0.1.0", function="invoke"][Instruction::CallWasm] enter', {
    funcName: 'invoke',
    paramCount: 4,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'saveCustomer010Invoke',
    getCallbackFn: () => null,
    callbackFnName: null,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => saveCustomer010Invoke(ptr1, len1, ptr2, len2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="app:customer/save-customer@0.1.0", function="invoke"][Instruction::Return]', {
    funcName: 'invoke',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./save_customer.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./save_customer.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    postReturn0 = exports1['cabi_post_app:customer/save-customer@0.1.0#invoke'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_app:customer/save-customer@0.1.0#invoke']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_app:customer/save-customer@0.1.0#invoke'];
    }
    
    saveCustomer010Invoke = exports1['app:customer/save-customer@0.1.0#invoke'];
  })();
...
await $init;
const saveCustomer010 = {
  invoke: invoke,
  
};

export { saveCustomer010 as saveCustomer, saveCustomer010 as 'app:customer/save-customer@0.1.0',  }